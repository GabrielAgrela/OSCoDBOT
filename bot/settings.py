...
SETTINGS_SCHEMA: List[Dict[str, Any]] = [
    ...
    {
        "key": "UI_MARGIN_LEFT_PCT",
        "label": "UI margin left",
        "type": "string",
        "category": "Interaction",
        "default": "0.3%",
        "description": "Horizontal margin offset for the overlay UI (supports % suffix).",
    },
    {
        "key": "UI_MARGIN_TOP_PCT",
        "label": "UI margin top",
        "type": "string",
        "category": "Interaction",
        "default": "35%",
        "description": "Vertical margin offset for the overlay UI (supports % suffix).",
    },
    {
        "key": "SAVE_SHOTS",
    ...
    },
    {
        ...
        "category": "Interaction",
        "default": "F12",
        "description": "Global hotkey used to stop the bot (if supported).",
    },
    {
        "key": "WEB_BIND_HOST",
        "label": "Web bind host",
    ...
    {
        "key": "USE_WEBVIEW",
        "label": "Use embedded webview",
        "type": "bool",
        "category": "Web UI",
        "default": _bool_default(False),
        "description": "Open the control panel in an embedded webview when available.",
    },
    {
        "key": "WEB_PORT",
        "label": "Web port",
